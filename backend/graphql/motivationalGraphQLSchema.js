...
var MotivationalVideoModel = require("../models/motivationalVideo.server.model");
...
const motivationalVideoQuery = {
    ...
    motivationalVideo: {
        ...
        resolve: async (root, args) => {
            const motivationalVideo = await MotivationalVideoModel.findById(args.id).exec();
...
const motivationalVideoMutation = {
    ...
    updateMotivationalVideo: {
        ...
        resolve: async (root, args) => {
            return await MotivationalVideoModel.findByIdAndUpdate(args.id, { $set: { title: args.title, description: args.description, videoUrl: args.videoUrl } }, { new: true });
        }
    },
    deleteMotivationalVideo: {
        ...
        resolve: async (root, args) => {
            const removedMotivationalVideo = await MotivationalVideoModel.findByIdAndRemove(args.id).exec();
...
module.exports = { motivationalVideoQuery: motivationalVideoQuery,motivationalVideoMutation: motivationalVideoMutation };
